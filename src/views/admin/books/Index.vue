        ...
        >
          ...
          <template #table-row="props">
            <span v-if="props.column.field == 'slug'">
              <router-link class="px-3 py-1 m-1 text-sm text-white bg-teal-600 rounded hover:text-gray-700" :to="{name : 'Book' , params : {slug : props.row.slug}}" ><i class="fa-solid fa-circle-info"></i></router-link>
            </span>
