<template>
      <div class="flex justify-center">
        <div
          class="relative flex flex-wrap p-2 text-gray-500 rounded-lg"
        >
        <div v-for="(comment,index) in comments" :key="comment.id" style=" box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;" class="relative z-40 w-[47%] p-2 m-2 rounded-lg bg-sky-100">
