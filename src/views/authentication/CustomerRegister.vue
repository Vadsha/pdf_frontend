            ...
            <div class="relative py-3 sm:max-w-xl sm:mx-auto">
                  ...
                  <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                        <div class="max-w-md mx-auto">
                              <div>
                                    <h1 class="text-2xl italic font-semibold">Welcome to <span class="text-teal-500">Nerdy </span><span class="text-red-500">Spot</span></h1>
                              </div>
                              <div class="divide-y divide-gray-200">
                                    <div class="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                                          <form @submit.prevent="register">
                                                <div class="relative">
                                                      <input v-model="formData.name" autocomplete="off" type="text" class="w-full h-10 text-gray-900 placeholder-transparent border-b-2 border-gray-300 peer focus:outline-none focus:borer-rose-600" placeholder="Name" />
                                                ...
                                                <div class="relative mt-4">
                                                      <input autocomplete="off" v-model="formData.password_confirmation"  type="password" class="w-full h-10 text-gray-900 placeholder-transparent border-b-2 border-gray-300 peer focus:outline-none focus:borer-rose-600" placeholder="Password" />
                                                      <label for="password" class="absolute left-0 -top-5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Confirm Password</label>
                                                </div>
                                                <div class="relative mt-4">
                                                      <p class="mb-2 text-base">Already have an account? <router-link class="ml-2 text-teal-600" :to="{name : 'CustomerLogin'}">Sign in</router-link></p>
